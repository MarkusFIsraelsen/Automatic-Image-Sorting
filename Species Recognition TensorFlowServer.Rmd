...
testImg = list.files(testImg.path)[3:length(list.files(testImg.path))]
...
animals = Asamples
rm(ani.samp, fox.samp, testImg, Asamples)
...
train_pool = c(animals[1:30], empty[1:30]) # vector of training images (30 first images of each list)
